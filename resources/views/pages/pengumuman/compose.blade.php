...
@section('title', 'Sistem Informasi Kearsipan / Tulis Pengumuman')
...
<ol class="breadcrumb v-spacing">
  ...
  <li><a class="active" href="{{URL::route('pengumuman.compose')}}">Tulis Pengumuman</a></li>
</ol>
  ...
  <div class="col-sm-6 col-md-3 col-xs-12">
    <div class="panel panel-default">
      ...
      <div class="list-group">
        ...
        <a href="{{URL::route('pengumuman.compose')}}" class="list-group-item active"><i class="fa fa-pencil"></i> Tulis Pengumuman</a>
      </div>
    </div>
  </div>
  <div class="col-sm-6 col-md-9 col-xs-12">
    <div class="panel with-nav-tabs panel-default">
        ...
        <div class="panel-body">
          <form id="form" class="form" action="{{URL::route('pengumuman.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <textarea id="isi" name="isi" style="display: none;" required data-parsley-errors-messages-disabled></textarea>
