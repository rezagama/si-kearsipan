...
(function(f) {
    ...
    f.extend(k.prototype, {
        ...
        _constructor: function() {
            ...
            if (this.c.blurable)
                f(i).on("click.keyTable", function(c) {
        ...
        _focus: function(a, b) {
            var d = this, c = this.s.dt, e = c.page.info(), l = this.s.lastFocus;
            if (this.s.enable) {
                if ("number" !== typeof a) {
                    var j =
                    a.index(), b = j.column, a = c.rows({
                        filter: "applied",
                        order: "applied"
                    }).indexes().indexOf(j.row);
                    e.serverSide && (a += e.start)
                }
                if ( - 1 !== e.length && (a < e.start || a >= e.start + e.length))
                    this.s.focusDraw=!0, c.one("draw", function() {
                        d.s.focusDraw=!1;
                        d._focus(a, b)
        ...
        _scroll: function(a, b, d, c) {
            var c = d[c](), e = d.outerHeight(), d = d.outerWidth(), f = b.scrollTop(), j = b.scrollLeft(), i = a.height(), a = a.width();
        ...
        _shift: function(a, b, d) {
            ...
            j = this.s.lastFocus, g = this._columns();
            if (j) {
                var h = c.rows({
                    filter: "applied",
                    order: "applied"
        ...
        _tabInput: function() {
            ...
            if ( - 1 != d)
                f('<div><input type="text" tabindex="' + d + '"/></div>').css({
                    position: "absolute",
                    height: 1,
                    width: 0,
                    overflow: "hidden"
    ...
    d) {
        ...
        if (!a || b === m)
            return d;
        for (var e = 0, f = d.length; e < f; e++)(!0 === b && a.focused(d[e]) ||!1 === b&&!a.focused(d[e])
            ) && c.push(d[e]);
        return c
    });
