...
(function(e) {
    ...
    e.extend(h.prototype, {
        ...
        fnScrollToRow: function(a, b) {
            ...
            f < this.s.redrawTop) && this.s.dt._iDisplayStart !== j)
        ...
        _fnDrawCallback: function() {
            ...
            this.s.skip=!0;
            this._fnScrollForce();
            c = 0 === f ? this.s.topRowFloat * b.row : f + j >= h ? b.scroll - (h - this.s.topRowFloat) * b.row : this._domain("virtualToPhysical", this.s.topRowFloat *
            b.row);
        ...
        _fnInfo: function() {
            if (this.s.dt.oFeatures.bInfo) {
                ...
                k).replace("_TOTAL_", l) + " " + b.sInfoFiltered.replace("_MAX_", a.fnFormatNumber(a.fnRecordsTotal())) + b.sInfoPostFix;
