...
(function(e) {
    ...
    e.extend(m.prototype, {
        ...
        _keypress: function(a, b) {
            ...
            for (d = i.length; c < d; c++) {
                f = 0;
                for (h = i[c].length; f < h; f++)
                    k(i[c][f].conf, i[c][f].node)
            }
    ...
    m.background = function(a,
    b,
    c) {
        c === n && (c = 400);
        a ? e("<div/>").addClass(b).css("display",
        "none").appendTo("body").fadeIn(c): e("body > div." + b).fadeOut(c,
        function() {
            e(this).remove()
        })
    ...
    m.buttonSelector = function(a, b) {
        for (var c = [], d = function(a, b) {
            ...
            if (e.isArray(a) || a instanceof e) {
                ...
                "object" === typeof a && a.nodeName && (f = e.inArray(a, g), - 1 !== f && c.push({
                    inst: b,
                    idx: b.toIndex(g[f])
                }))
